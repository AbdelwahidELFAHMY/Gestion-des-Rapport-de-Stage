...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["dates"]) && !empty($_POST["dates"])) {
        ...
        $selectedDate = $_POST["dates"][0];
        echo $selectedDate;

        // Préparer une requête pour récupérer les chemins des fichiers pour la date sélectionnée
        $sql = "SELECT Chemin_fichier,Titre_rapport,ID_rapport,Description_rapport,Date_depot FROM rapport_stage WHERE Date_depot = '$selectedDate'";
